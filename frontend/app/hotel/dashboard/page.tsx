...
import { Calendar, Users, Bed, DollarSign, TrendingUp, TrendingDown } from "lucide-react"
...
const roomTypeData = [
  ...
  { name: "Deluxe", value: 25, color: "#10B981" },
  { name: "Suite", value: 20, color: "#F59E0B" },
  { name: "Presidential", value: 20, color: "#EF4444" },
]

const todaysReservations = [
  { id: 1, guest: "John Smith", room: "101", checkIn: "14:00", status: "confirmed" },
  { id: 2, guest: "Sarah Johnson", room: "205", checkIn: "15:30", status: "pending" },
  { id: 3, guest: "Mike Wilson", room: "312", checkIn: "16:00", status: "confirmed" },
  { id: 4, guest: "Emma Davis", room: "108", checkIn: "17:00", status: "confirmed" },
]
