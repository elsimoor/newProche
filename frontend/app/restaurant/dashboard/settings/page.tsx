...
export default function RestaurantSettings() {
  ...
  const [settings, setSettings] = useState({
    ...
    address: "123 Culinary Street, Food District, FD 12345",
  ...
  const [businessHours, setBusinessHours] = useState<BusinessHours[]>([
    { id: "1", day: "Monday", isOpen: true, openTime: "17:00", closeTime: "23:00" },
    { id: "2", day: "Tuesday", isOpen: true, openTime: "17:00", closeTime: "23:00" },
    { id: "3", day: "Wednesday", isOpen: true, openTime: "17:00", closeTime: "23:00" },
    { id: "4", day: "Thursday", isOpen: true, openTime: "17:00", closeTime: "23:00" },
    { id: "5", day: "Friday", isOpen: true, openTime: "17:00", closeTime: "24:00" },
    { id: "6", day: "Saturday", isOpen: true, openTime: "16:00", closeTime: "24:00" },
    { id: "7", day: "Sunday", isOpen: true, openTime: "16:00", closeTime: "22:00" },
  ])
  ...
  const [policies, setPolicies] = useState<Policy[]>([
    {
      ...
      description:
        "Reservations can be cancelled up to 2 hours before your booking time. Tables are held for 15 minutes past reservation time.",
      category: "Booking",
    },
    {
      id: "2",
      ...
      description:
        "Our restaurant maintains a smart casual dress code. We reserve the right to refuse service to guests who do not meet our dress standards.",
      category: "General",
    },
    {
      id: "3",
      ...
      description:
        "A service charge of 18% will be added to parties of 6 or more. Additional gratuity is at your discretion.",
      category: "Payment",
    },
  ])
  ...
  const handleSave = () => {
    console.log("Settings saved:", { settings, businessHours, paymentMethods, policies })
